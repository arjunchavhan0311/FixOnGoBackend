...
public class EmailService {
	...
	public void sendOtpEmail(String toEmail, String otp) throws MessagingException {
		...
		String htmlContent = "<!DOCTYPE html>" + "<html>" + "<head>" + "<style>"
				...
				+ ".footer {margin-top:20px; font-size:12px; color:#555; text-align:center;}" + "</style>" + "</head>"
				+ "<body>" + "<div class='container'>" + "<div class='header'><h2>FixOnGo</h2></div>" + "<p>Hello,</p>"
				+ "<p>Your OTP for password reset is:</p>" + "<div class='otp'>" + otp + "</div>"
				+ "<p>This OTP is valid for 10 minutes.</p>" + "<p>If you didn’t request this, ignore the email.</p>"
				+ "<div class='footer'>© 2026 FixOnGo Smart Worker Hiring Platform  . All rights reserved.</div>"
				+ "</div>" + "</body>" + "</html>";
	...
	// -------------------- Send Credentials Email (Admin / Worker / Customer)
	public void sendCredentialsEmail(String toEmail, String password, String userType) throws MessagingException {
		...
		String htmlContent = "<!DOCTYPE html>" + "<html>" + "<head>" + "<style>"
				...
				+ ".footer {margin-top:20px; font-size:12px; color:#555; text-align:center;}" + "</style>" + "</head>"
				+ "<body>" + "<div class='container'>" + "<div class='header'><h2>FixOnGo</h2></div>" + "<p>Hello "
				+ userType + ",</p>"
				+ "<p>Your account has been created successfully. Use the following credentials to login:</p>"
				+ "<div class='credentials'>" + "Email: " + toEmail + "<br/>" + "Password: " + password + "</div>"
